...
public class Finconattachment implements Serializable {
	 ...
	 *
	 */
	public void copy(Finconattachment that) {
		setId(that.getId());
	...
	public boolean equals(Object obj) {
	    if (obj == this)
	        return true;
	    if (!(obj instanceof Finconattachment))
	        return false;
	    Finconattachment equalCheck = (Finconattachment) obj;
